...
export default function TaskIntroduction() {
    ...
    return (
        <Box>
            ...
            {/*        <Typography variant="h6" gutterBottom>Take the test on your knowledge</Typography>*/}
            {/*    </Box>*/}
            {/*</Box>*/}
            <ListItem>
                <ListItemAvatar>
                ...
                task.map((i, index) => {
                    return(
                        <div className={alertRootClass.alertRoot}>
                            <Alert variant="outlined" severity="info" icon={<Typography>{i.variant}</Typography>}
