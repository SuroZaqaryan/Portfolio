...
export default function Variables_and_String(props) {
    ...
    return (
        <>
            <CustomBlockContainer>
                <LessonSideBarTitle>JavaScript Variables and Strings <span className={"LessonEmoji"}>🏷️</span></LessonSideBarTitle>
            </CustomBlockContainer>
